  ...
  return (
    <Col className="about-block" xl={6} lg={6} md={12} sm={12} xs={12}>
      ...
      <div className="about py-3">
        <h5 className="mb-2">Добро пожаловать на сайт СНТ «ПОКРОВСКИЕ ДАЧИ»</h5>
        <p>
        ...
        <p>
          ...
          километрах от г. Наро-Фоминск, граничит с лесным массивом и рекой
          Нара.
        </p>
        <p>
          <strong>Полное наименование:</strong>&nbsp; Садоводческое
          Некоммерческое Товарищество «Покровские дачи»
        </p>
        <p>
          <strong>Сокращенное наименование:</strong>&nbsp; СНТ «Покровские
          дачи».
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Социальная инфраструктура: Прод. магазина нет, в пределах
            досягаемости вся инфраструктура п. Атепцево
          </li>
          <li>
